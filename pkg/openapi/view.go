...
func (v *Viewer) View(ctx context.Context, path, method string) (string, error) {
	...
	return v.renderPaths(path, method)
}
...
// renderPaths contains the common logic for rendering paths after the spec is loaded
func (v *Viewer) renderPaths(path, method string) (string, error) {
